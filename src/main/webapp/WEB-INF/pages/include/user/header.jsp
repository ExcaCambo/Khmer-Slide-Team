<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>      
      ...
      </div><a href="index.jsp" class="brand pull-left"><img src="${pageContext.request.contextPath}/resources/static/img/logo/Khmer-Slide.png" alt="" width="100"></a><a href="javascript:;" role="button" class="hamburger-menu pull-left"><span></span></a>
