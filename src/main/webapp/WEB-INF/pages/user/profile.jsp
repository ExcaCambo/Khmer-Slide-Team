	...
	<div class="main-container">
      ...
      <div class="page-container">
              ...
              <div class="btn-group mt-5">
                ...
                <ul class="dropdown-menu dropdown-menu-right animated fadeInDown">
                  ...
                  <li><a href="#"><i class="flag-icon flag-icon-jp mr-5"></i> Japanese</a></li>
                   <li><a href="#"><i class="flag-icon flag-icon-vn mr-5"></i> Cambodia</a></li>
                </ul>
              </div>
            </div>
          </div>
        ...
        <div class="page-content container-fluid p-0">
          <div class="row row-0">
            <div class="col-lg-12">
              <div style="height: 260px; padding-top: 130px; background-image: url(${pageContext.request.contextPath}/resources/static/img/backgrounds/profile.png)" class="bg-overlay pl-30 pr-30 clearfix text-white">
                <div class="pull-left media">
                  <div class="media-left"><a href="javascript:void(0)" style="display: inline-block; border-radius: 50%; padding: 3px; background-color: #fff;"><img src="${pageContext.request.contextPath}/resources/static/img/users/06.jpg" width="100" alt="" class="media-object img-circle"></a></div>
          ...
          <!--     <div class="widget clear">
            ...
            <div class="col-md-6">
              <div class="widget clear">
                <div class="widget-heading">
                  <div class="media">
                    <div class="media-left"><img src="${pageContext.request.contextPath}/resources/static/img/users/10.jpg" alt="" class="media-object mo-lg img-circle"></div>
                ...
                <div class="widget-body">
                  ...
                  <ul class="media-list">
                    <li class="media">
                      <div class="media-left avatar"><img alt="" src="${pageContext.request.contextPath}/resources/static/img/users/01.jpg" class="media-object img-circle"><span class="status bg-success"></span></div>
                      <div class="media-body">
                        ...
                        <div class="media">
                          <div class="media-left avatar"><img alt="" src="${pageContext.request.contextPath}/resources/static/img/users/12.jpg" class="media-object img-circle"><span class="status bg-success"></span></div>
                          <div class="media-body">
                            ...
                            <div class="media">
                              <div class="media-left avatar"><img alt="" src="${pageContext.request.contextPath}/resources/static/img/users/11.jpg" class="media-object img-circle"><span class="status bg-success"></span></div>
                              <div class="media-body">
                        ...
                        <div class="media">
                          <div class="media-left avatar"><img alt="" src="${pageContext.request.contextPath}/resources/static/img/users/14.jpg" class="media-object img-circle"><span class="status bg-success"></span></div>
                          <div class="media-body">
              ...
              <div class="widget clear">
                <div class="widget-heading">
                  <div class="media">
                    <div class="media-left"><img src="${pageContext.request.contextPath}/resources/static/img/users/12.jpg" alt="" class="media-object mo-lg img-circle"></div>
                    <div class="media-body media-middle">
                ...
                <div class="widget-body">
                  <ul class="media-list mb-0">
                    <li class="media"><a href="javascript:;" class="conversation-toggle">
                        <div class="media-left avatar"><img src="${pageContext.request.contextPath}/resources/static/img/users/10.jpg" alt="" class="media-object img-circle"><span class="status bg-success"></span></div>
                        <div class="media-body">
                          <h5 class="media-heading">Philip Fernandez</h5>
                          <p class="text-muted mb-0">489 Rhapsody Street</p>
                        </div></a></li>
                    <li class="media"><a href="javascript:;" class="conversation-toggle">
                        <div class="media-left avatar"><img src="${pageContext.request.contextPath}/resources/static/img/users/20.jpg" alt="" class="media-object img-circle"><span class="status bg-success"></span></div>
                        <div class="media-body">
                    ...
                    <li class="media"><a href="javascript:;" class="conversation-toggle">
                        <div class="media-left avatar"><img src="${pageContext.request.contextPath}/resources/static/img/users/06.jpg" alt="" class="media-object img-circle"><span class="status bg-warning"></span></div>
                        <div class="media-body">
                          <h5 class="media-heading">John Cruz</h5>
                          <p class="text-muted mb-0">3274 Lyndon Street</p>
                        </div></a></li>
                    <li class="media"><a href="javascript:;" class="conversation-toggle">
                        <div class="media-left avatar"><img src="${pageContext.request.contextPath}/resources/static/img/users/19.jpg" alt="" class="media-object img-circle"><span class="status bg-success"></span></div>
                        <div class="media-body">
        ...
        <div data-mcs-theme="minimal-dark" class="tab-content nav-sidebar-content mCustomScrollbar">
          <div id="chat" role="tabpanel" class="tab-pane fade in active">
            ...
            <ul class="chat-list mb-0 fs-12 media-list">
              ...
              <li class="media"><a href="javascript:;" class="conversation-toggle">
                  <div class="media-left avatar"><img src="${pageContext.request.contextPath}/resources/static/img/users/01.jpg" alt="" class="media-object img-circle"><span class="status bg-success"></span></div>
                  <div class="media-body">
              ...
              <li class="media"><a href="javascript:;" class="conversation-toggle">
                  <div class="media-left avatar"><img src="${pageContext.request.contextPath}/resources/static/img/users/03.jpg" alt="" class="media-object img-circle"><span class="status bg-warning"></span></div>
                  <div class="media-body">
              ...
              <li class="media"><a href="javascript:;" class="conversation-toggle">
                  <div class="media-left avatar"><img src="${pageContext.request.contextPath}/resources/static/img/users/05.jpg" alt="" class="media-object img-circle"><span class="status bg-success"></span></div>
                  <div class="media-body">
                    <h6 class="media-heading">Hannah Williamson</h6>
                    <p class="text-muted mb-0">Do you know the address?</p>
                  </div></a></li>
              <li class="media"><a href="javascript:;" class="conversation-toggle">
                  <div class="media-left avatar"><img src="${pageContext.request.contextPath}/resources/static/img/users/06.jpg" alt="" class="media-object img-circle"><span class="status bg-success"></span></div>
                  <div class="media-body">
                    <h6 class="media-heading">Anthony Mills</h6>
                    <p class="text-muted mb-0">No problem.</p>
                  </div></a></li>
              <li class="media"><a href="javascript:;" class="conversation-toggle">
                  <div class="media-left avatar"><img src="${pageContext.request.contextPath}/resources/static/img/users/07.jpg" alt="" class="media-object img-circle"><span class="status bg-warning"></span></div>
                  <div class="media-body">
                    <h6 class="media-heading">Ethan Stanley</h6>
                    <p class="text-muted mb-0">Hello?</p>
                  </div></a></li>
              <li class="media"><a href="javascript:;" class="conversation-toggle">
                  <div class="media-left avatar"><img src="${pageContext.request.contextPath}/resources/static/img/users/08.jpg" alt="" class="media-object img-circle"><span class="status bg-success"></span></div>
                  <div class="media-body">
                  ...
                  <div class="media-right"><span class="badge bg-danger">1</span></div></a></li>
              <li class="media"><a href="javascript:;" class="conversation-toggle">
                  <div class="media-left avatar"><img src="${pageContext.request.contextPath}/resources/static/img/users/09.jpg" alt="" class="media-object img-circle"><span class="status bg-success"></span></div>
                  <div class="media-body">
                    <h6 class="media-heading">Denise Rose</h6>
                    <p class="text-muted mb-0">Bye bye.</p>
                  </div></a></li>
              <li class="media"><a href="javascript:;" class="conversation-toggle">
                  <div class="media-left avatar"><img src="${pageContext.request.contextPath}/resources/static/img/users/10.jpg" alt="" class="media-object img-circle"><span class="status bg-danger"></span></div>
                  <div class="media-body">
      ...
      <aside class="conversation closed">
        ...
        <ul data-mcs-theme="minimal-dark" class="media-list chat-content fs-12 pl-20 pr-20 mCustomScrollbar">
          <li class="media">
            <div class="media-left avatar"><img src="${pageContext.request.contextPath}/resources/static/img/users/04.jpg" alt="" class="media-object img-circle"><span class="status bg-success"></span></div>
            <div class="media-body">
              <p>Hello.</p>
          ...
          <li class="media other">
            ...
            <div class="media-right avatar"><img src="${pageContext.request.contextPath}/resources/static/img/users/18.jpg" alt="" class="media-object img-circle"><span class="status bg-success"></span></div>
          </li>
          <li class="media">
            <div class="media-left avatar"><img src="${pageContext.request.contextPath}/resources/static/img/users/04.jpg" alt="" class="media-object img-circle"><span class="status bg-success"></span></div>
            <div class="media-body">
