							...
							<div class="widget-body">
								<table id="cat-list-table" style="width: 100%"
									...
									<thead style="width: 100px">
										<tr>
											<th style="width: 2px">លេខរៀង</th>
											<th style="width: 20px">ឈ្មោះមីនុយ</th>
											<th style="width: 5px">ស្ថិតក្រោមមីនុយ</th>
											<th style="width: 12px">បញ្ចុលដោយ</th>
											<th style="width: 10%">ស្ថានភាព</th>
											<th style="width: 10px">សកម្មភាព</th>
											<th style="width: 10px">ពត៌មានបន្ថែម</th>
										</tr>
									</thead>
									<tbody>
											...
											<td>
												<div class="media">
													<div class="media-body">
														<h5 class="media-heading">{{CAT.CAT_NAME}}</h5>
														<p class="text-muted mb-0">បញ្ចូលថ្ងៃទី:{{CAT.CREATED_DATE}}</p>
													</div>
												</div>
											</td>
											<td>{{CAT.PARENT.CAT_NAME}}</td>
											<td>{{CAT.USER.USER_NAME}}</td>
										 	<td class="text-center" ng-class="(CAT.STATUS == 1) ? 'text-success':'text-danger'"><i ng-class="(CAT.STATUS == 1) ? 'ti-check' : 'ti-close'"></i></td>
												...
												<div role="toolbar" aria-label="Toolbar with button groups"
													...
													<div role="group" aria-label="First group"
														...
														<button type="button" class="btn btn-outline btn-warning"
															data-toggle="modal" data-target=".modalEdit" ng-click="listByID(CAT.CAT_ID)">
															<i class="ti-pencil"></i>
														</button>
														<!-- button delete -->
														<button type="button" ng-click="deleteCategoryList(CAT.CAT_ID)" class="btn btn-outline btn-danger">
															<i class="ti-trash"></i>
														</button>
													</div>
												</div>
